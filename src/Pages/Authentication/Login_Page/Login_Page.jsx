        ...
        <div className="w-[100%] flex">
            ...
            <div className="w-[100%] h-[100%] p-10">
                <div className="w-[600px] h-[100%] mx-auto bg-gray-50 border border-gray-100 rounded-lg p-16">
                    <h1 className="text-4xl font-bold text-slate-800 text-center mb-10">Sign in to Hero,s</h1>
                    {/* login form */}
                    <form>
                        {/* Username */}
                        <div className="mb-10">
                            <label className="text-xl font-bold text-slate-800">Username/Email Address</label>
                            <br />
                        ...
                        <input type="submit" value="Login Account" className="w-[100%] h-[66px] bg-emerald-700 hover:bg-emerald-600 rounded-lg text-2xl text-white font-semibold tracking-[1px] cursor-pointer mb-8" />
                    </form>
                    <p className="text-lg font-bold text-slate-800 text-center">Please register at first. Go to <Link to="/auth/signup" className="text-emerald-500 text-xl font-bold hover:underline">SIGN UP</Link></p>
                </div>
            </div>
        </div>
    );
