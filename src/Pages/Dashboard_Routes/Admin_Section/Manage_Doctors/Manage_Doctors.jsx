...
import avatar from "../../../../../public/image/banner_image/banner_doctor_3.jpeg";

const Manage_Doctors = () => {
    return (
        <div className="w-[1030px] mx-auto my-10">
            <h1 className="text-3xl font-bold text-slate-800">Manage Doctors: 06</h1>
            <div className="my-10">
                    ...
                    <table className="table">
                        ...
                        <thead className="bg-slate-900">
                            <tr>
                                ...
                                <th className="text-2xl font-bold text-white ">Avater</th>
                                <th className="text-2xl font-bold text-white ">Name</th>
                                <th className="text-2xl font-bold text-white ">SPECIALITY</th>
                            ...
                            <tr className="bg-slate-600 shadow-2xl">
                                ...
                                <td>
                                    <div className="w-[60px] h-[60px]">
                                        <img className="w-[100%] h-[100%] rounded-[50%]" src={avatar} alt="" />
                                    </div>
                                </td>
                                <td className="text-lg text-white font-[500]">Cy Ganderton</td>
                                <td className="text-lg text-white font-[500]">dental</td>
                                <td>
                                    <button className="text-xl text-white hover:text-slate-800 font-[700] py-3 px-3 border border-white rounded-lg shadow-2xl bg-slate-500 hover:bg-slate-300 hover:shadow-inner">Delete</button>
                                </td>
                            </tr>
                            {/* row 2 */}
                            <tr className="bg-slate-600 shadow-2xl">
