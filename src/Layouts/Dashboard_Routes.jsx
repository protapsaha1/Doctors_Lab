        ...
        <div className="grid grid-cols-[1fr,3fr]">
            <div className="bg-slate-100 h-[46.5rem]">
                <ul>
                    ...
                    {/* Users routes */}
                    <>
                        <li className="text-2xl font-bold text-slate-800 w-[100%] h-[80px]  flex items-center ps-20 hover:bg-slate-200 tracking-[1px]"><Dash_Links to="/dash/my-appoinment">My Appointments</Dash_Links></li>
                        <li className="text-2xl font-bold text-slate-800 w-[100%] h-[80px]  flex items-center ps-20 hover:bg-slate-200 tracking-[1px]"><Dash_Links to="/dash/my-history">My Reviews</Dash_Links></li>
                        <li className="text-2xl font-bold text-slate-800 w-[100%] h-[80px]  flex items-center ps-20 hover:bg-slate-200 tracking-[1px]"><Dash_Links to="/dash/my-reviews">My History</Dash_Links></li>
                    </>
